...
module.exports = {
    ...
    async execute(ita, args, client) {
        ...
        var embed = new discord.MessageEmbed()
            ...
            .setTitle(
                (function() {if(user.data.badges && user.data.badges.verified) {return `${require('../../emotes.json').verified} `} else return ''})() +
                (function() {if(user.data.badges && user.data.badges.partner) {return `${require('../../emotes.json').partner} `} else return ''})() +
                user.user.username)
